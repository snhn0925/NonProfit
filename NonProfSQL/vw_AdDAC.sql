...
SELECT 
	...
	cat.TotalAdCost,
	COUNT(DISTINCT ad.DonorID) AS DonorCnt,
	CAST(cat.TotalAdCost/COUNT(DISTINCT ad.DonorID) AS NUMERIC(10,2)) AS DAC
FROM CTE_AdTransact cat
JOIN CTE_AdDonor ad ON cat.AdvertisementID = ad.AdvertisementID
JOIN dbo.DonorGiftAssoc dga ON ad.DonorID = dga.DonorID
